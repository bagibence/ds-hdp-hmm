...
def sample_one_step_ahead(zt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, alpha0, gamma0, sigma0, mu0, sigma0_pri, rho0, K):
    T = len(zt)
...
def init_gibbs(rho0, alpha0, gamma0, sigma0, mu0, sigma0_pri, T, yt):
    ...
    zt, n_mat, ysum, ycnt, beta_vec, beta_new, K = sample_one_step_ahead(zt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, alpha0, gamma0, sigma0, mu0, sigma0_pri, rho0, K)
    return rho0, alpha0, gamma0, sigma0, mu0, sigma0_pri, K, zt, beta_vec, beta_new, n_mat, ysum, ycnt

def init_gibbs_full_bayesian(alpha0_a_pri, alpha0_b_pri, gamma0_a_pri, gamma0_b_pri, c_pri, d_pri, sigma0, mu0, sigma0_pri, T, yt):
    K = 1
    zt = np.zeros(T, dtype='int')
...
def init_gibbs_full_bayesian_regular(alpha0_a_pri, alpha0_b_pri, gamma0_a_pri, gamma0_b_pri, sigma0, mu0, sigma0_pri, T, yt):
    K = 1
    zt = np.zeros(T, dtype='int')
    ...
    zt, n_mat, ysum, ycnt, beta_vec, beta_new, K = sample_one_step_ahead(zt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, alpha0, gamma0, sigma0, mu0, sigma0_pri, 0, K)
...
def sample_zw(zt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, alpha0, gamma0, sigma0, mu0, sigma0_pri, rho0, K):
    ...
    zt, n_mat, ysum, ycnt, beta_vec, beta_new, K = sample_last(zt, yt, n_mat, ysum, ycnt, beta_vec, beta_new, alpha0, gamma0, sigma0, mu0, sigma0_pri, rho0, K)
